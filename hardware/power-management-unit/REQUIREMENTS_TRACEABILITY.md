...
Date: 2026-09-10. This is a design cross-reference, not a declaration that CAD, ERC, DRC, assembly or hardware validation has passed.
...
| CHOP-002 | REV_A_ASSUMPTION | Two external RH10010R00FE01, 10 Ω/100 W parallel; 5 Ω, 8.6 A/369.8 W at 43 V. Separate 305 × 305 × 3.2 mm Al plates; ≥500 J bounded cold test supported by manufacturer short-overload evidence. | A06/T5 staged energy limit; repetitive duty, actual energy and chassis transfer remain B03. No repetitive pulse curve invented. |
...
| PCB-001 | PROVISIONAL | Four layers, 70 µm outer/35 µm inner copper planned; C. | D4/D6 final stackup and fabricator capability; no completed routing claim here. |
| PCB-002 | LOCKED | Broad paired outer pours, dense layer transfers and calculated 15 × 2 mm copper reinforcement; 160-via full-current transfer basis; C. | D4 validate actual bar splits, FET necks, vias and nets. B06 resistance/temperature; bulk copper arithmetic alone is insufficient. |
...
| PCB-004 | REV_A_ASSUMPTION | Generous 360 × 300 mm bench outline, four mount positions, edge access, antenna exclusion, separate resistor plates and insulated bars. | A12 dimensions await final CAD comparison. D4/D6 assembly access/height; B12 final enclosure/airflow/mechanics. |
| PCB-005 | REV_A_DESIGN | Higher-current M5 studs selected instead of unproven Mega-Fit/4 mm² combination; J3–J6, 25 A each arm planning envelope. | P/C part evidence; D6 exact lug/crimp selection and B06 current/temperature/derating. |
...
| Provisional mechanics and reinforcement | C calculations, placement files, A12 and D4/D6; completed PCB comparison remains required. |
...
| Rev-A CAD/fabrication/order review | D0–D7 must establish captured/routed connectivity, reviewed ERC/DRC and assembly outputs; this traceability table reports no CAD pass. Owner review precedes any order. |
