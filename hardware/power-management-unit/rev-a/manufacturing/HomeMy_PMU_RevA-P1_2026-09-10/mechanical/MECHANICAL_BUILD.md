...
**Verbindliche Montageanforderung für den Rev-A-P1-Engineering-Prototyp. Engineering prototype – not production qualified.** Der Paket-Manifest legt den freigegebenen PCB-Stand fest. Die Busbar-Bohrkoordinaten und Netze sind gegen die tatsächlichen PCB-Kontakte geprüft. Dies ist keine Strombelastbarkeits-, Betriebs- oder Serienfreigabe; Coupon- und Losprüfungen bleiben erforderlich.
...
- Die aktuellen Hauptfelder enthalten116/104/189/148/117/215 Vias für BATT_SENSED_P/MAIN_COMMON/SYS_BUS_P/MOTION_SENSED_P/MOTION_COMMON/MOTION_BUS_P und723 für BATT_N. Das sind Feldsummen, keine lokale Stromfreigabe. Über die ganze Platine verteilte Vias dürfen nicht einer einzelnen Kontaktstelle zugerechnet werden. Lagewechsel und reale Stromverteilung bleiben Teil des Qualifikationsnachweises.
...
## Abgleich mit dem endgültigen Rev-A-P1-PCB

BC1–BC15, die acht durchbohrten NT-Sternbrücken, Q40-Source-Rückweg,
LED-Leistungsrückleiter und die M5-Montageorientierungen sind im CAD integriert.
Die Bohrkoordinaten der sieben Busbars stimmen mit den tatsächlichen Kontaktpads
überein. Die Hochstromregelprüfung hat den unteren BATT_N-Rückleiter zusätzlich
bis Y=137 mm verbreitert. BB7 bleibt an seinen definierten Kontakten und mit
seiner freigegebenen Kontur Y=105..136 mm montiert.

247 Leistungs-Padverbindungen sind ohne Anrechnung der 492 dünnen Steuerabzweige
geometrisch verbunden. Alle 48 Pressfit-Pads sind angeschlossen. Die aktuellen
85 Querschnittsmessungen und verbleibenden Engstellen sind im Bestellpaket unter
`evidence/POWER_CROSS_SECTIONS.csv` und `evidence/HIGH_CURRENT_RULES.md` enthalten.
Die zwei Arm-Messfenster ergeben 12,5 mm, nicht die frühere 20-mm-Rechenannahme.
Frühere Idealrechnungen oben bleiben illustrative Beispiele, keine Messwerte.

Die geometrische Freiraumprüfung ersetzt keinen realen Werkzeug-/Gehäusetest.
Externe Träger, Kabelschuhe und Abdeckungen passen sich den eingefrorenen
PCB-Schnittstellen an; zusätzliche PCB-Bohrungen erfordern eine neue Revision.
