...
parts=json.loads((root/'design/wake-io-parts.json').read_text())['components'];place=json.loads((root/'design/placement-wake.json').read_text());lib=pathlib.Path('C:/Users/chrba/Documents/ChatGPT/HomeMy/tools-local/kicad/share/kicad/footprints');boxes={}
for c in parts:
 x,y,angle=place[c['ref']]
 if c['footprint'].startswith('PMU:'):
  boxes[c['ref']]=(x-1.8,y-1.8,x+1.8,y+1.8);continue
