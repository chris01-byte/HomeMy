...
(root/'evidence/chopper-placement-courtyard-check.json').write_text(json.dumps({'scope':'Own chopper parts only; integrated check remains required','component_count':len(parts),'courtyard_overlaps':coll},indent=2)+'\n')
